...
class Ui_TIPE(object):
    def setupUi(self, TIPE):
        ...
        self.formLayoutNewGame.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labelPlayer2)
        ...
        self.formLayoutNewGame.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.comboBoxPlayer2)
        ...
        self.formLayoutNewGame.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.pushButtonNewGame)
